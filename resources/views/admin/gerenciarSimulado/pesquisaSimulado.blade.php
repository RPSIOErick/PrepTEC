...
@section('title', 'Pesquisa Simulado - PrepTEC')
    ...
    <div class="container-fluid">
        ...
        <!--Row Principal-->
            <div class="row row-cols-1">
                            ...
                            <div class="row row-cols-2">
                                ...
                                <!--Coluna Botões-->
                                    <div class="col" id="d-CRUD-R-colBTNread">
                                        <button id="btn-CRUD-R-btnVoltarListagemGeral"><a href="/simulado/listar">Voltar para a <br>Listagem Geral</a></button>
                                    </div>
                                ...
                                <table id="table-quest-voc" class="table-striped">
                                    ...
                                    @foreach ($resultadoSimulado as $resultado)
                                        <tr id="table-result-data">
                                            ...
                                            <td id="table-quest-voc-linha"> {{$resultado->id_quest}} </td>
                                            <td id="table-quest-voc-linha"> {{$resultado->txt_quest}} </td>
                                            <td id="table-quest-voc-linha-intMult"> {{$resultado->txt_perg}} </td>
                                            <td id="table-quest-voc-linha-func">

                                                <center>
                                                    <a name="edit" class="btn-template-icon" href="#Popup-Excl-{{$resultado->id_quest}}">
                                                    ...
                                                    <!-- Popup de Exclusão -->
                                                        <div id="Popup-Excl-{{$resultado->id_quest}}" class="overlay">
                                                            <div class="popup">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col" id="Form-Excl">
                                                                        ...
                                                                        <center>
                                                                            ...
                                                                            <form action="/simulado/excluir/{{$resultado->id_quest}}" method="POST" id="table-quest-voc-form-excl-{{$resultado->id_quest}}">
                                                                                @csrf
                                                                                @method('delete')
                                                                                <input type="text" value="{{$resultado->id_quest}}" name="id_quest" hidden>                
                                                                                
                                                                                <p id="Form-Excl-p"> Deseja mesmo excluir essa questão? Questão: {{$resultado->id_quest}}</p>
                                                    ...
                                                    <!--Botão Editar-->
                                                        <a name="edit" class="btn-template-icon" href="{{url("/simulado/editar/$resultado->id_quest")}}">
                ...
                <button id="btn-CRUD-R-btnVoltarListagemGeral-mobile"><a href="/simulado/listar">Voltar a Listagem Geral</a></button>
